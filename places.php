...
while ($loop->have_posts()) : $loop->the_post();
    ...
    $url = "https://maps.googleapis.com/maps/api/place/findplacefromtext/json?fields=name,place_id&input=$title&inputtype=textquery&key=YOUR_API_KEY_HERE";
...
function populate_hours($post_id, $place_id)
{
    ...
    $url = "https://maps.googleapis.com/maps/api/place/details/json?fields=opening_hours&place_id=$place_id&key=YOUR_API_KEY_HERE";
    $response = wp_remote_get($url);
    $jsonObj = json_decode($response['body']);
